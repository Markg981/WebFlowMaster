...
export async function processTestPlanJob(
  ...
  // ⚡ Bolt: Optimized from multiple O(N) .filter() and .some() calls to a single O(N) pass.
  // This avoids unnecessary memory allocations for intermediate arrays and reduces time complexity.
