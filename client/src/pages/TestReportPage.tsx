...
export interface TestPlanExecutionReport {
  ...
  failedTestDetails: Array<{
    id: string; testName: string; browser: string | null; reasonForFailure: string | null; screenshotUrl: string | null;
    steps: ReportStep[];
  ...
  testGroupings: Record<string, {
    ...
    components: Record<string, {
      ...
      tests: Array<{
        ...
        testType: 'ui' | 'api'; testName: string; browser: string | null; status: 'Passed' | 'Failed' | 'Skipped' | 'Pending' | 'Error';
        steps: ReportStep[];
...
const TestReportPage: React.FC = () => {
  ...
  const [openedSteps, setOpenedSteps] = useState<{ testName: string; browser: string | null; steps: ReportStep[] } | null>(null);
